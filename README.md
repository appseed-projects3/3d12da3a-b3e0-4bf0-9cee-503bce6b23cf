...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-05 16:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3d12da3a-b3e0-4bf0-9cee-503bce6b23cf.git
$ cd 3d12da3a-b3e0-4bf0-9cee-503bce6b23cf
```
